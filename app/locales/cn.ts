...
const cn = {
  ...
  Settings: {
    ...
    // {{CHENGQI:
    // Action: Added - 自定义模型管理的本地化文本
    // Timestamp: 2025-06-18 16:50:00 +08:00
    // Reason: 为自定义模型管理功能添加中文本地化支持
    // Principle_Applied: DRY - 统一的本地化管理
    // Optimization: 完整的用户界面文本支持
    // Architectural_Note (AR): 扩展本地化系统以支持新功能
    // Documentation_Note (DW): 自定义模型管理的完整中文界面文本
    // }}
    CustomModelManager: {
      Title: "自定义模型管理",
      Manage: "管理自定义模型",
      ...
      Export: "导出配置",
      Import: "导入配置",
      NoModels: "暂无自定义模型，点击添加按钮开始创建",

      ModelName: "模型名称",
      ModelNamePlaceholder: "请输入模型名称，如：gpt-4-custom",
      DisplayName: "显示名称",
      DisplayNamePlaceholder: "请输入显示名称（可选）",
      DisplayNameSubTitle: "在模型选择器中显示的名称，留空则使用模型名称",

      Enabled: "启用状态",
      EnabledSubTitle: "是否在模型选择器中显示此模型",
      Status: "状态",
      Disabled: "已禁用",
      ...
      InvalidName: "模型名称只能包含字母、数字、点号、下划线和连字符",

      AddSuccess: "自定义模型添加成功",
      UpdateSuccess: "自定义模型更新成功",
      DeleteSuccess: "自定义模型删除成功",
      DeleteConfirm: "确认删除此自定义模型？删除后无法恢复。",

      ExportSuccess: "自定义模型配置导出成功",
      ImportSuccess: "自定义模型配置导入成功",
